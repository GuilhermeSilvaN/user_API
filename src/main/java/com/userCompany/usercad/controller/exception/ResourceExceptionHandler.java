package com.userCompany.usercad.controller.exception;
...
public class ResourceExceptionHandler {
    ...
    public ResponseEntity<StandardError> handleException(ResourceNotFoundException ex, HttpServletRequest request) {
        String error = "Resource Not Found bro";
    ...
    public ResponseEntity<StandardError> handleException(DatabaseException e, HttpServletRequest request) {
